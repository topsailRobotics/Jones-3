...
//CHANGE THESE CHANGE THESE CHANGE THESE CHANGE THESE CHANGE THESE CHANGE THESE CHANGE THESE CHANGE THESE CHANGE THESE CHANGE THESE
  ...
  public static final class ElevatorConstants {
    public static final int kELeftMotorCANID = 53;
    public static final int kERightMotorCANID = 57;
    public static final double ElevatorSetPointVal = -10;
  }
  public static final class EndEffecterConstants {
    public static final int kEELeftMotorCANID = 58;
    public static final int kEERightMotorCANID = 59;
  }
  public static final class KickerConstants {
    public static final int kKickerArmCANID = 60;
    public static final int kKickerWheelCANID = 61;
    public static final double kKickerSetPointVal = 1;
  }
