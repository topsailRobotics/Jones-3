...
//THIS IS WHAT NEEDS TO BE FIXED 
 ...
 //commands commented out so could test out end effecter, should uncomment when needed
/* 
    ...
    new JoystickButton(m_driverController, XboxController.Button.kX.value)
        .onTrue(new RunCommand(
               () -> m_elevator.ElevatorSetPoint(-13),
                m_elevator));//alongWith(Blinkin.idleBlinkin(), Blinkin));
...
*/
    ...
    new JoystickButton(m_driverController, XboxController.Button.kY.value)
        .onTrue(new RunCommand(
            () -> m_elevator.ElevatorSetPoint(-26),
            m_elevator));

 /* 
    new JoystickButton(m_driverController, XboxController.Button.kB.value)
        .onTrue(new RunCommand(
           () -> m_kicker.KickerSetPoint(6),
           m_kicker));
           */       
    new JoystickButton(m_driverController, XboxController.Button.kB.value)
